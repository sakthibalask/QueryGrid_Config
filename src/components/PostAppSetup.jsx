// src/components/PostAppSetup.jsx
...
const PostAppSetup = ({ onSetupComplete }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setTimeout(() => {
                if (typeof onSetupComplete === "function") onSetupComplete(ip);
            }, 600);
        } catch (error) {
                ...
                <div className="login-form-content">
                    ...
                    <form className="login-form" onSubmit={handleSubmit}>
                        ...
                        <div className="login-field login-button-field">
                            <button type="submit" className="login-btn">Setup & Test Connection</button>
                        </div>
                    </form>
                </div>
            </div>
